...
import com.example.josuecadillo.semana07sqltables.adapter.ListCompaniesAdapter;
...
public class ListCompaniesActivity extends Activity implements OnItemLongClickListener, OnItemClickListener, OnClickListener {
    ...
    public static final int REQUEST_CODE_EDIT_COMPANY = 50;
	...
	private void showDeleteDialogConfirmation(final Company clickedCompany) {
        ...
        alertDialogBuilder.setMessage("Seguro desea eliminar \""+clickedCompany.getName()+"\" la compania ?");
